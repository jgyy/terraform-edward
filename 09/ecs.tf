...
module "my-ecs" {
  source         = "github.com/jgyy/terraform-modules//modules/ecs-cluster"
...
module "my-service" {
  source              = "github.com/jgyy/terraform-modules//modules/ecs-service"
  vpc_id              = module.vpc.vpc_id
...
module "my-alb" {
  source             = "github.com/jgyy/terraform-modules//modules/alb"
  vpc_id             = module.vpc.vpc_id
  lb_name            = "my-alb"
...
module "my-alb-rule" {
  source           = "github.com/jgyy/terraform-modules//modules/alb-rule"
